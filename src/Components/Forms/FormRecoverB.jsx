  ...
  return (
    <>
      <form onSubmit={(e) => (
        ...
        Para restablecer tu contraseña se necesita que ingrese tu <a className="text-RojoC">correo electrónico</a> de recuperación:  <a className="text-verdeC">hu************@gmail.com</a>.
        </p>
