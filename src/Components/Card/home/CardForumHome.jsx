      ...
      <div className="flex flex-col w-full h-full bg-white rounded-md p-3 border border-verdeC hover:bg-slate-100">
        ...
        <div className="flex flex-col justify-between h-full">
          ...
          <ul className="flex gap-2 md:gap-3 lg:gap-4 flex-wrap font-barolw text-sm md:text-base xl:text-lg">
            <li
              className={`flex gap-2 items-center text-sm justify-center bg-verdeA py-1 px-3 bg-opacity-90 rounded-md`}
            >
              {forum.likeCount}
              <AiFillLike className={` text-base`} />
            </li>
            <li className="flex gap-2 items-center text-sm justify-center bg-verdeA py-1 px-3 bg-opacity-90 rounded-md">
              {forum.commentCount}
